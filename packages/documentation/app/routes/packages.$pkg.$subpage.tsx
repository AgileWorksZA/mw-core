...
export default function PackageSubpage() {
	const { packageName, subpage, content, processedHtml, tableOfContents } =
			...
			<div className="flex gap-8">
				...
				<div className="flex-1 min-w-0">
					<div className="flex items-start justify-between mb-6">
						<h1 className="text-4xl font-bold">{content.meta.title}</h1>
						<DocSearch content={content.content} packageName={packageName} />
					</div>
