        ...
        <div className="container mx-auto px-4 py-16">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-8 inline-flex items-center gap-2 rounded-lg bg-gray-100 dark:bg-gray-800 px-4 py-2 text-sm">
              <kbd className="rounded bg-white dark:bg-gray-700 px-2 py-1 text-xs font-semibold">⌘K</kbd>
              <span className="text-gray-600 dark:text-gray-400">to search APIs</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {coreAPIs.map((api) => (
                <div key={api.title} className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6">
              ...
              {packages.map((pkg) => (
                ...
                >
                  ...
                  <div className="flex items-start gap-4 mb-4">
                    <div className={`p-3 rounded-lg ${pkg.bgColor} ${pkg.color} group-hover:scale-110 transition-transform`}>
                      {pkg.icon}
                    </div>
                  ...
                  <ul className="space-y-2 mb-4">
                    {pkg.highlights.map((highlight, i) => (
                      <li key={i} className="flex items-start gap-2 text-sm text-gray-600 dark:text-gray-400">
                        <span className={`mt-1.5 w-1.5 h-1.5 rounded-full ${pkg.bgColor} flex-shrink-0`} />
                        <span>{highlight}</span>
                      </li>
                    ))}
                  </ul>
                  ...
                  <div className={`flex items-center text-sm font-medium ${pkg.color} group-hover:gap-3 transition-all`}>
                    View API docs 
