/**
 * MoneyWorks Contact Repository
 *
 * @moneyworks-entity Contact
 * @moneyworks-dsl PURE
 * @ai-instruction This repository handles all Contact data operations
 * @ai-critical Use MoneyWorks Contact terminology exclusively
 *
...
/**
 * Repository for MoneyWorks Contact entity
 *
 * @ai-instruction Use this for all Contact data operations
 * @ai-term Say "ContactRepository", NEVER "PersonRepository" or "StaffRepository"
 *
 * KEY RELATIONSHIPS:
 ...
 */
export class ContactRepository extends BaseMoneyWorksRepository<
	MoneyWorksContact,
	MoneyWorksContactCreateInput,
	MoneyWorksContactUpdateInput
> {
	 ...
	 */
	protected readonly tableName = "Contact";
