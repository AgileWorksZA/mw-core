...
import { MoneyWorksQueryParams, MoneyWorksResponse } from '../config/types';
 ...
 */
export abstract class BaseMoneyWorksRepository<T, TCreate = Partial<T>, TUpdate = Partial<T>> 
   ...
   */
  async find(search?: string, params: MoneyWorksQueryParams = {}): Promise<T[]> {
   ...
   */
  async findWithRelated(search?: string, params?: MoneyWorksQueryParams): Promise<T[]> {
 ...
 */
export function createRepository<T extends BaseMoneyWorksRepository<any, any, any>>(
