...
import type { TableStructure } from "../parsers/field-discovery";
...
export function validateTSVStructure(
	...
	if (
		...
		structure.fields[0].dataType === "number"
	) {
		warnings.push(
			"First field appears to be a header, but TSV should not have headers",
		);
	}
