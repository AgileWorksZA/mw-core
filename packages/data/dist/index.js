...
export { discoverTableStructure, clearFieldCache, getCachedStructure, buildTSVHeaders } from './parsers/field-discovery';
 ...
 * ```
 */
export async function createDataLayer(configPath) {
