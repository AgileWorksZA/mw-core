 ...
 */
export function parseMoneyWorksXML(xml) {
    // Extract table name
 ...
 */
export function extractFieldOrder(xml) {
 ...
 */
export function xmlFieldToPascalCase(xmlField) {
 ...
 */
export function buildFieldMapping(xmlFieldOrder) {
