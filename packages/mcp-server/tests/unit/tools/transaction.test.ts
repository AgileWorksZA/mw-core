...
const mockTransactionService = createMockService(
	MOCK_RESPONSES.transactions.success,
);
...
describe("Transaction Tools", () => {
	describe("searchTransactionsTool", () => {
		...
		it("should validate input schema", () => {
			...
			expect(() =>
				searchTransactionsTool.inputSchema.parse(validArgs),
			).not.toThrow();
		});
		...
		it("should reject invalid transaction type", () => {
			...
			expect(() =>
				searchTransactionsTool.inputSchema.parse(invalidArgs),
			).toThrow();
		});
		...
		it("should support all valid transaction types", () => {
			...
			for (const type of validTypes) {
				...
				expect(() =>
					searchTransactionsTool.inputSchema.parse(args),
				).not.toThrow();
			}
		});
	...
	describe("getTransactionTool", () => {
		...
		it("should validate input schema", () => {
			...
			expect(() =>
				getTransactionTool.inputSchema.parse(validArgs),
			).not.toThrow();
		});
	...
	describe("getTransactionByRefTool", () => {
		...
		it("should validate input schema", () => {
			...
			expect(() =>
				getTransactionByRefTool.inputSchema.parse(validArgs),
			).not.toThrow();
		});
	});
	...
	describe("getTransactionSummaryTool", () => {
		...
		it("should validate input schema", () => {
			...
			expect(() =>
				getTransactionSummaryTool.inputSchema.parse(validArgs),
			).not.toThrow();
		});
	});
