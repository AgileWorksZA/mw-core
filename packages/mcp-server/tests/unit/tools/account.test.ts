...
describe("Account Tools", () => {
  describe("searchAccountsTool", () => {
    ...
    it("should validate input schema", () => {
      ...
      expect(() => searchAccountsTool.inputSchema.parse(validArgs)).not.toThrow();
    });
  ...
  describe("getAccountTool", () => {
    ...
    it("should throw error for non-existent account", async () => {
      ...
      const mockEmptyService = createMockService(MOCK_RESPONSES.accounts.notFound);
  ...
  describe("Error handling", () => {
    it("should handle service errors gracefully", async () => {
      ...
      await expect(searchAccountsTool.execute(args)).rejects.toThrow("Service unavailable");
