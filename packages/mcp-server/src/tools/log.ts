...
const logToolSchema = z.object({
	operation: z
		...
		.describe("The operation to perform: search for logs, get specific log, or list available fields"),
	...
	sequenceNumber: z.number().optional().describe("The log sequence number to retrieve (get operation only)"),
	code: z.string().optional().describe("The log code to retrieve (get operation only)"),
});

export const logTool = {
	description: "Unified tool for log operations: search logs, get specific log, or list available fields",
