...
const userToolSchema = z.object({
	operation: z
		...
		.describe("The operation to perform: search for users, get specific user, or list available fields"),
	...
	sequenceNumber: z.number().optional().describe("The user sequence number to retrieve (get operation only)"),
	code: z.string().optional().describe("The user code to retrieve (get operation only)"),
});

export const userTool = {
	description: "Unified tool for user operations: search users, get specific user, or list available fields",
