...
const ledgerToolSchema = z.object({
	operation: z
		...
		.describe("The operation to perform: search for ledgers, get specific ledger, or list available fields"),
	...
	sequenceNumber: z.number().optional().describe("The ledger sequence number to retrieve (get operation only)"),
	code: z.string().optional().describe("The ledger code to retrieve (get operation only)"),
});

export const ledgerTool = {
	description: "Unified tool for ledger operations: search ledgers, get specific ledger, or list available fields",
