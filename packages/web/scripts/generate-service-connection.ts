...
import { generateAdapter } from "../app/modules/ide/adapter/generator/index";
  ...
  try {
    const result = await generateAdapter({
      ...
      variables: {
        ...
        adapterDescription: "Service connection configuration for external services",
        moduleNamespace: "serviceconnection",
        contextTypeName: "ServiceConnectionContext",
        dataTypeName: "ServiceConnectionData",
        acceptedFileTypes: ".connection.json, .svc.json",
    ...
    console.log("\n🎯 Next steps:");
    console.log("1. Review the generated files in app/modules/service-connection.ide/");
    console.log("2. Customize the editor component for connection configuration");
