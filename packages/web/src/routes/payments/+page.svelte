...
<div class="flex h-full flex-col">
	<PageHeader title="Payments" subtitle="{data.summary.total} payments">
		<div class="flex items-center gap-3">
			...
			<a href="/payments/new" class="rounded-xl bg-primary px-4 py-1.5 text-sm font-semibold text-primary-foreground hover:opacity-90 transition-opacity">New Payment</a>
		</div>
	</PageHeader>
