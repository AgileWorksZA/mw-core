<script lang="ts">
	...
	const navItems = [
		...
		{ href: '/batch-receipts', label: 'Batch Receipts', icon: 'arrow-down', group: 'Sales' },
		...
		{ href: '/receive-goods', label: 'Receive Goods', icon: 'box', group: 'Purchases' },
		...
		{ href: '/batch-payments', label: 'Batch Payments', icon: 'arrow-up', group: 'Purchases' },
