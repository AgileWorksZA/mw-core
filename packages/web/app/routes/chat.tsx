...
import { Brain, Bug, Check } from "lucide-react";
				...
				<div className="flex-1 overflow-y-auto p-4" ref={chatContainerRef}>
					{messages.length === 0 ? (
						<div className="text-center text-gray-500 mt-8 space-y-4">
							<p className="text-lg">
								Start a new conversation with MoneyWorks AI
							</p>
							<div className="max-w-lg mx-auto bg-blue-50 dark:bg-blue-950 p-4 rounded-lg text-sm text-left">
								...
								<p className="text-gray-600 dark:text-gray-400">
									This chat uses domain-specific knowledge cards to provide
									accurate MoneyWorks information. Click the brain icon above to
									manage knowledge cards and improve AI responses.
								</p>
							</div>
						</div>
					) : (
