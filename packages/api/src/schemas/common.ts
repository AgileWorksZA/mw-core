...
export const CommonHeaders = t.Object({
  ...
  'x-ratelimit-limit': t.Optional(t.String({ description: 'Rate limit ceiling' })),
  'x-ratelimit-remaining': t.Optional(t.String({ description: 'Remaining requests' })),
  'x-ratelimit-reset': t.Optional(t.String({ description: 'Rate limit reset time' }))
});