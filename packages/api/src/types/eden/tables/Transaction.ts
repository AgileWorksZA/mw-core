...
export const TransactionOne = t.Object(
  {
    ...
    TransDate: t.String({
      description:
        "Transaction date (indexed, mutable: conditionally). The date of the transaction.",
    }),
    EnterDate: t.Nullable(
      t.String({
        description:
          "Date entered (indexed). The date on which the transaction was entered.",
      }),
    ),
    DueDate: t.Nullable(
      t.String({
        description:
          "Due date (mutable: conditionally). For invoices, this is the date that the invoice is due for payment.",
      }),
    ),
    Period: t.Nullable(
      t.Integer({
    ...
    Description: t.Nullable(
      t.String({
        description:
          "Description (mutable: conditionally). The description of the transaction.",
        maxLength: 1024,
      }),
    ),
    Gross: t.Nullable(
    ...
    DatePaid: t.Nullable(
      t.String({
        description:
          "Date paid. The date the last payment for an invoice was made.",
      }),
    ),
    AmtPaid: t.Nullable(
      t.Number({
        description:
          "Amount paid. The amount of the invoice that has been paid.",
      }),
    ),
    PayAmount: t.Nullable(
      t.Number({
        description:
    ...
    TaxProcessed: t.Nullable(
      t.Integer({
        description: "Tax processed amount.",
      }),
    ),
    Salesperson: t.Nullable(
      t.String({
        description:
    ...
    Colour: t.Nullable(
      t.Integer({
        description:
          "Display color (mutable: conditionally). The color index, 0-7.",
        min: 0,
        max: 7,
      }),
    ),
    BankJNSeq: t.Nullable(
      t.Integer({
        description:
    ...
    PromptPaymentDate: t.Nullable(
      t.String({
        description:
          "Prompt payment date . The date the prompt payment discount expires.",
      }),
    ),
    PromptPaymentAmt: t.Nullable(
      t.Integer({
        description:
          "Prompt payment amount. The amount of the eligible prompt payment discount.",
      }),
    ),
    ProdPriceCode: t.Nullable(
      t.String({
        description: "Product price code. Pricing level (A-F).",
        maxLength: 2,
      }),
    ),
    MailingAddress: t.Nullable(
      t.String({
        description:
    ...
    ExchangeRate: t.Nullable(
      t.Integer({
        description: "Exchange rate (0 for base currency transactions).",
      }),
    ),
    EnteredBy: t.Nullable(
      t.String({
        description:
          "Entered by user. Initials of user who entered the transaction.",
        maxLength: 4,
      }),
    ),
    PostedBy: t.Nullable(
