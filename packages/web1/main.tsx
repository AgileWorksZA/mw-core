    ...
    <div style={{ padding: '20px', fontFamily: 'system-ui' }}>
      ...
      <table style={{ borderCollapse: 'collapse', width: '100%' }}>
        ...
        <tbody>
          {taxRates.map((rate) => (
            <tr key={rate.TaxCode}>
              <td style={{ border: '1px solid #ddd', padding: '8px' }}>{rate.TaxCode}</td>
              <td style={{ border: '1px solid #ddd', padding: '8px' }}>{rate.Ratename}</td>
              <td style={{ border: '1px solid #ddd', padding: '8px' }}>{rate.Rate1}%</td>
            </tr>
          ))}
        </tbody>
      </table>
