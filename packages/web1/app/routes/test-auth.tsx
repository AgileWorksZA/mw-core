    ...
    <div className="p-8">
      ...
      <div className="mt-8 space-y-2">
        ...
        <ul className="list-disc ml-6">
          <li><a href="/sign-in" className="text-blue-600 hover:underline">Sign In</a></li>
          <li><a href="/onboarding" className="text-blue-600 hover:underline">Onboarding</a></li>
          <li><a href="/dashboard" className="text-blue-600 hover:underline">Dashboard</a></li>
          <li><a href="/connections" className="text-blue-600 hover:underline">Connections</a></li>
        </ul>
      </div>
