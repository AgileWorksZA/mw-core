...
function ConnectionsContent() {
  ...
  const { connections, currentConnection, isLoading, error, refreshConnections, setCurrentConnection } = useConnection();
            ...
            {connections.map((connection) => (
              <Card 
                ...
                className={cn(
                  ...
                  currentConnection?.id === connection.id && "ring-2 ring-primary"
                )}
              >
                ...
                <CardContent>
                  <dl className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <dd className="font-medium truncate max-w-[150px]" title={connection.mw_data_file}>
