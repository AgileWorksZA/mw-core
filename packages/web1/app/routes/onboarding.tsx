		...
		try {
			...
			if (!response.ok) {
				...
				if (response.status === 409) {
					throw new Error(
						"A connection with this name already exists. Please use a different name.",
					);
				}
						...
						<div className="space-y-6">
							<div className="space-y-4">
								...
								<div className="space-y-4 border-t pt-4">
									<p className="text-sm text-muted-foreground">
										Optional: Two-level authentication (if your server requires
									...
									<div className="grid grid-cols-2 gap-4">
										...
										<div>
											<Label htmlFor="mw_folder_password">
												Folder Password
											</Label>
											<Input
							...
							<div className="flex justify-between">
								...
								<Button
									...
									disabled={
										!formData.mw_data_file || !formData.mw_username || isLoading
									}
								>
									{isLoading ? (
										<>
						...
						<div className="space-y-6">
							...
							<div className="text-center space-y-2">
								...
								<p className="text-muted-foreground">
									Your MoneyWorks connection has been verified and is ready to
									use.
								</p>
							</div>
							...
							<div className="rounded-lg border bg-muted/50 p-4">
								<dl className="space-y-2 text-sm">
									...
									<div className="flex justify-between">
										...
										<dd>
											{formData.mw_host}:{formData.mw_port}
										</dd>
									</div>
									<div className="flex justify-between">
