...
import { useLoaderData, Form, useNavigate, useParams } from "react-router";
...
export async function action({ request, params }: ActionFunctionArgs) {
  ...
  const data: Partial<TaxRate> = {
    ...
    Rate1: parseFloat(formData.get("TaxRate") as string) / 100,
    Type: parseInt(formData.get("TaxType") as string),
