 ...
 *
 * Renders time-series data as a line chart using Recharts.
 * Features: axis labels, tooltips, multiple series, legend.
 */
...
import type { LineChartData } from "~/lib/artifacts/types";
