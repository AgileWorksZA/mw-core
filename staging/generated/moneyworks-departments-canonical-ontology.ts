...
export const MONEYWORKS_DEPARTMENT_FIELDS = [
	{
		...
		canonicalDescription:
			"The classification code for the department. References General table Department Classifications (prefix: D).",
	...
	},
	{
		...
		maxLength: undefined,
		canonicalDescription:
			"The date that this department was last changed. This means a change to the department record itself, not a change to any account balance associated with the department.",
		manualSource: "moneyworks_appendix_departments.html",
		isRequired: false,
		isIndexed: false,
	},
 ...
 */
export const MONEYWORKS_DEPARTMENT_REQUIRED_FIELDS =
	MONEYWORKS_DEPARTMENT_FIELDS.filter((field) => field.isRequired).map(
 ...
 */
export const MONEYWORKS_DEPARTMENT_INDEXED_FIELDS =
	MONEYWORKS_DEPARTMENT_FIELDS.filter((field) => field.isIndexed).map(
		(field) => field.fieldName,
	);
 ...
 */
export const MONEYWORKS_DEPARTMENT_CUSTOM_FIELDS =
	MONEYWORKS_DEPARTMENT_FIELDS.filter(
		(field) =>
			field.fieldName.startsWith("Custom") ||
			field.fieldName.startsWith("User"),
	).map((field) => field.fieldName);

/**
 * System-managed department fields
 */
export const MONEYWORKS_DEPARTMENT_SYSTEM_FIELDS =
	MONEYWORKS_DEPARTMENT_FIELDS.filter((field) => field.dataType === "S").map(
		(field) => field.fieldName,
	);
...
export const MONEYWORKS_DEPARTMENT_RELATIONSHIPS = {
	referencedBy: ["Accounts", "Transactions", "Jobs", "Names"],
	references: [
		{
			entity: "General",
...
export const MONEYWORKS_DEPARTMENT_VALIDATION_RULES = {
	...
	classificationOptional:
		"Classification code is optional but limited to 5 characters",
...
export const MONEYWORKS_DEPARTMENT_BUSINESS_MAPPINGS = {
	restaurant: ["Kitchen", "Front of House", "Bar", "Management", "Maintenance"],
	legal: [
		"Litigation",
		"Corporate",
		"Family Law",
	...
	manufacturing: ["Production", "Quality Control", "Warehouse", "R&D", "Sales"],
	retail: [
		"Sales Floor",
		"Inventory",
		"Customer Service",
