...
export const MONEYWORKS_TRANSACTION_FIELDS = [
	...
	},
	{
		...
		canonicalDescription:
			"Initials of first user to approve transaction. This field can only be set to the current user's initials (or blank) using a script.",
		manualSource: "moneyworks_appendix_transactions.html",
	...
	},
	{
		...
		maxLength: 3,
		canonicalDescription:
			"Initials of second user to approve transaction. This field can only be set to the current user's initials (or blank) using a script.",
		manualSource: "moneyworks_appendix_transactions.html",
		relationshipTarget: "Login.Initials",
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The sequence number of the journal which banked the receipt (using the Banking command)",
		manualSource: "moneyworks_appendix_transactions.html",
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The colour, represented internally as a numeric index in the range 0-7 but rendered as a textual colour name",
		manualSource: "moneyworks_appendix_transactions.html",
	...
	},
	{
		...
		maxLength: 7,
		canonicalDescription:
			"For CP and CR transactions, this contains the account code of the bank that was selected in the bank pop-up menu. For invoices this is the accounts payable/receivable control acct.",
		manualSource: "moneyworks_appendix_transactions.html",
		relationshipTarget: "Accounts.Code",
		relationshipRule:
			"References bank account for cash transactions or control account for invoices",
	},
	{
		fieldName: "DatePaid",
		dataType: "D" as const,
	...
	},
	{
		...
		maxLength: 255,
		canonicalDescription:
			"The delivery address for this transaction. Blank if default from name.",
		manualSource: "moneyworks_appendix_transactions.html",
	...
	},
	{
		...
		maxLength: 255,
		canonicalDescription:
			"Transaction's mailing address. Blank if default from name.",
		manualSource: "moneyworks_appendix_transactions.html",
		relationshipTarget: "Names address fields",
	...
	},
	{
		...
		relationshipRule:
			"References creditor (supplier) or debtor (customer) from Names entity",
	},
	{
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The sequence number of the order that created the invoice through the ship or receive goods commands",
		manualSource: "moneyworks_appendix_transactions.html",
		relationshipTarget: "Transaction.SequenceNumber",
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The amount of the invoice that you have elected to pay a creditor in the next payment run.",
		manualSource: "moneyworks_appendix_transactions.html",
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The payment method for the transaction (0 = None, 1 = Cash, 2 = Cheque, 3 = Electronic, 4 = Credit Card, 5-7 = user defined)",
		manualSource: "moneyworks_appendix_transactions.html",
	...
	},
	{
		...
		dataType: "B" as const,
		canonicalDescription:
			'"True" if the transaction is a recurring transaction. "False" if it isn\'t.',
		manualSource: "moneyworks_appendix_transactions.html",
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The transaction's security level. This is set to the highest security level of the visible detail lines.",
		manualSource: "moneyworks_appendix_transactions.html",
	...
	},
	{
		...
		maxLength: 1,
		canonicalDescription:
			'This will be either a "U" (for unposted) or "P" (for posted).',
		manualSource: "moneyworks_appendix_transactions.html",
		isRequired: true,
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"A number representing the GST cycle in which the transaction was processed for GST. This is 0 for transactions not yet processed for GST.",
		manualSource: "moneyworks_appendix_transactions.html",
	...
	},
	{
		...
		maxLength: 200,
		canonicalDescription:
			"For a payment, the To field. For a receipt, the From field.",
		manualSource: "moneyworks_appendix_transactions.html",
...
export const MONEYWORKS_DETAIL_FIELDS = [
	{
		...
		maxLength: 14,
		canonicalDescription:
			"A text string containing the account code- (or account-department code) from the detail line",
		manualSource: "moneyworks_appendix_transactions.html",
		isRequired: true,
		relationshipTarget: "Accounts.Code",
		relationshipRule:
			"References chart of accounts, may include department suffix",
	},
	{
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The detail.net amount converted to the base currency",
		manualSource: "moneyworks_appendix_transactions.html",
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"This is the base currency buy-price of the product. It is represented as dollars per buying unit for a purchase or as dollars per selling unit. for a sale. For a sale, the cost price is taken from the AverageValue of the product.",
		manualSource: "moneyworks_appendix_transactions.html",
	...
	},
	{
		...
		dataType: "D" as const,
		canonicalDescription:
			"The date on the detail line (also the expiry date for time-limited batches)",
		manualSource: "moneyworks_appendix_transactions.html",
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The amount of non-claimable sales tax on the line (only set for transactions of type CI and CP that involve sales tax). When a line is saved, the net is adjusted up by this amount and the tax down; when the transaction is viewed, the reverse happens.",
		manualSource: "moneyworks_appendix_transactions.html",
		relationshipTarget: "tax calculation",
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The quantity of non-inventoried items on an order received but not invoiced",
		manualSource: "moneyworks_appendix_transactions.html",
		relationshipTarget: "order processing",
		relationshipRule:
			"Tracks non-inventory items received but not yet invoiced",
	},
	{
	...
	},
	{
		...
		dataType: "B" as const,
		canonicalDescription:
			"0 if not shipped or part shipped, 1 if fully shipped",
		manualSource: "moneyworks_appendix_transactions.html",
		relationshipTarget: "order fulfillment",
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The unit cost of an inventoried item before the transaction was posted (available for some lines involving stock replenishment)",
		manualSource: "moneyworks_appendix_transactions.html",
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"For stock purchase transactions, the buy quantity adjusted for the product conversion factor, gives the qty in sell units, which is the posted qty.",
		manualSource: "moneyworks_appendix_transactions.html",
	...
	},
	{
		...
		maxLength: 3,
		canonicalDescription:
			"For product transaction detail lines, this is the selling unit of measure as copied from the product record.",
		manualSource: "moneyworks_appendix_transactions.html",
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The security level of the line (inherited from the account's security level)",
		manualSource: "moneyworks_appendix_transactions.html",
	...
	},
	{
		...
		relationshipRule:
			"Serial number or batch number for inventory traceability",
	},
	{
		fieldName: "Detail.Statement",
		dataType: "N" as const,
		canonicalDescription:
			"The sequence number for the reconciliation record for which this detail line was reconciled. It is normally only used for detail lines which specify a bank account. If the item is not yet reconciled it contains a 0 (or a -1 if the reconciliation has been saved but not finalised).",
		manualSource: "moneyworks_appendix_transactions.html",
		relationshipTarget: "Reconciliation.SequenceNumber",
		relationshipRule:
			"Bank reconciliation linking for bank account detail lines",
	},
	{
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The quantity of the product specified by Detail.StockCode that is being purchased or sold. The units correspond to either the buyUnits for the product or the SellUnits for the product depending on whether this is a purchase (CP/CI) or a sale (CR/DI) transaction.",
		manualSource: "moneyworks_appendix_transactions.html",
		relationshipTarget: "inventory management",
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The order of the detail lines as displayed in a transaction.",
		manualSource: "moneyworks_appendix_transactions.html",
	...
	},
	{
		...
		maxLength: 2,
		canonicalDescription:
			"The first two characters of the transaction type (i.e. CP, CR, CI, DI, JN, PO, SO, QU)",
		manualSource: "moneyworks_appendix_transactions.html",
...
export const MONEYWORKS_TRANSACTION_TYPE_DEFINITIONS: MoneyWorksTransactionTypeDefinition[] =
	[
		...
		},
		{
			...
			manualSource: "moneyworks_appendix_transactions.html",
			businessContext:
				"Invoice received from creditor that has been fully paid",
			universalApplicability: [
				"restaurant",
				"retail",
				"consulting",
		...
		},
		{
			...
			manualSource: "moneyworks_appendix_transactions.html",
			businessContext:
				"General accounting entries for adjustments and corrections",
...
export function validateTransactionTypeCanonical(type: string): {
	...
	if (!validTypes.includes(type as MoneyWorksTransactionType)) {
		warnings.push(
			`Invalid transaction type ${type}. MoneyWorks canonical types: ${validTypes.join(", ")}`,
		);
	}
...
export function validateTransactionStatusCanonical(status: string): {
	...
	if (!validStatuses.includes(status as MoneyWorksTransactionStatus)) {
		warnings.push(
			`Invalid transaction status ${status}. MoneyWorks canonical statuses: U (unposted), P (posted)`,
		);
	}
 ...
 */
export function getCanonicalTransactionTypeExplanation(
	type: MoneyWorksTransactionType,
): string {
	const typeDef = MONEYWORKS_TRANSACTION_TYPE_DEFINITIONS.find(
		(def) => def.type === type,
	);
	if (!typeDef) {
 ...
 */
export function isCanonicalReceivableTransaction(
	type: MoneyWorksTransactionType,
): boolean {
	return [
 ...
 */
export function isCanonicalPayableTransaction(
	type: MoneyWorksTransactionType,
): boolean {
	return [
 ...
 */
export function isCanonicalCashTransaction(
	type: MoneyWorksTransactionType,
): boolean {
	return [
