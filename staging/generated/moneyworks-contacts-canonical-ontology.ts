...
export const MONEYWORKS_CONTACTS_FIELDS: MoneyWorksCanonicalContactField[] = [
...

	{
		...
		canonicalDescription:
			"Roles for the contact. This is a bit mapped field, with each bit representing a role.",
...
export const MONEYWORKS_CONTACTS_BUSINESS_RULES = [
	{
		...
		canonicalRule:
			"Contact must reference valid Name entity via ParentSeq → Names.Seq",
		manualSource:
			"moneyworks_appendix_contacts.html - Contacts table is subfile of Name table",
	},

	{
		...
		canonicalRule:
			"Role field uses bit mapping with each bit representing distinct contact role",
...

	{
		...
		ruleType: "constraint" as const,
		canonicalRule:
			"Order determines contact sequence within parent Name entity",
...

	{
		...
		canonicalRule:
			"Contacts subfile complements Names built-in Contact1/Contact2 fields - use Names for simple scenarios, Contacts for complex hierarchies",
		manualSource:
			"moneyworks_appendix_contacts.html + moneyworks_appendix_names.html analysis",
	},

	{
		...
		canonicalRule:
			"Contacts provides larger capacity for Contact(39), Mobile(19), Position(39), AfterHours(19) vs Names fields; Names provides larger email capacity(80)",
...

	{
		...
		ruleType: "architectural" as const,
		canonicalRule:
			"Contacts entity provides unlimited contacts per Name via subfile architecture, overcoming Names 2-contact limitation",
...

	{
		...
		canonicalRule:
			"Names Contact1/Contact2 embedded for fast access, Contacts subfile for detailed management - choose based on access patterns",
		manualSource:
			"Architectural analysis of embedded vs subfile access patterns",
	},

	{
		...
		ruleType: "capacity" as const,
		canonicalRule:
			"Contacts entity optimized for international operations with larger field capacities for names, mobile numbers, and positions",
...
export const MONEYWORKS_CONTACTS_CANONICAL_SUMMARY = {
	...
	dualLayerUsageGuidance: {
		useNamesOnly: {
			...
			reasoning:
				"Most businesses need only 1-2 contacts, Names provides fastest access",
		...
		useHybridApproach: {
			...
			reasoning:
				"Primary contacts in Names for speed, additional contacts in Contacts for detail",
			implementation:
				"Names Contact1/Contact2 + Contacts subfile for 3+ contacts",
		},
		...
		useContactsPrimary: {
			...
			reasoning:
				"Complex role management, unlimited expansion, enhanced field capacities required",
			implementation:
				"Contacts subfile as primary system, Names contact fields optional",
		},
	},
	...
	fieldCapacityComparison: {
		...
		namesAdvantage: {
			eMail:
				"63 chars vs Names.email(80)/email2(80) - Names provides more email capacity",
		},
