...
export const MONEYWORKS_NAME_FIELDS = [
	...
	},
	{
		...
		maxLength: 7,
		canonicalDescription:
			"The Accounts Receivable control account code for a debtor.",
		manualSource: "moneyworks_appendix_names.html",
	},
	{
		...
		maxLength: 7,
		canonicalDescription:
			"The Accounts Payable control account code for a creditor.",
		manualSource: "moneyworks_appendix_names.html",
	},
	{
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"For a debtor, the current balance. The total balance for the debtor is the sum of all the balance fields.",
		manualSource: "moneyworks_appendix_names.html",
	},
	{
...

	{
		...
		relationshipRule:
			"Primary contact can be supplemented by Contacts subfile for unlimited contacts",
	},
	{
		fieldName: "Contact2",
		dataType: "T" as const,
		...
		relationshipTarget: "Contacts.Contact",
		relationshipRule:
			"Secondary contact can be supplemented by Contacts subfile for unlimited contacts",
	},
...

	{
		...
		relationshipRule:
			"Built-in email field (max 80 chars) vs Contacts.eMail (max 63 chars) - Names provides more capacity",
	},
	{
		fieldName: "email2",
		dataType: "T" as const,
	...
	},
	{
		...
		relationshipRule:
			"Built-in mobile field (max 14 chars) vs Contacts.Mobile (max 19 chars) - Contacts provides more capacity",
	},
	{
		fieldName: "Mobile2",
		dataType: "T" as const,
		...
		relationshipTarget: "Contacts.Mobile",
		relationshipRule:
			"Built-in mobile field (max 13 chars) vs Contacts.Mobile (max 19 chars) - Contacts provides more capacity",
	},
	{
		fieldName: "DDI",
		dataType: "T" as const,
		...
		relationshipRule:
			"Built-in DDI field - same 19 char capacity as Contacts.DDI",
	},
	{
		fieldName: "DDI2",
		dataType: "T" as const,
	...
	},
	{
		...
		relationshipRule:
			"Built-in afterhours field (max 11 chars) vs Contacts.AfterHours (max 19 chars) - Contacts provides more capacity",
	},
	{
...

	{
		...
		relationshipRule:
			"Built-in position field (max 29 chars) vs Contacts.Position (max 39 chars) - Contacts provides more capacity",
	},
	{
		fieldName: "Position2",
		dataType: "T" as const,
	...
	},
	{
		...
		relationshipRule:
			"Built-in salutation field - same 39 char capacity as Contacts.Salutation",
	},
	{
...

	{
		...
		relationshipRule:
			"Built-in role field - same bit-mapped functionality as Contacts.Role",
	},
	{
		fieldName: "Role2",
		dataType: "N" as const,
	...
	},
	{
		...
		relationshipRule:
			"Built-in memo field - same 255 char capacity as Contacts.Memo",
	},
	{
		fieldName: "Memo2",
		dataType: "T" as const,
...
export const MONEYWORKS_CUSTOMER_TYPE_DEFINITIONS: MoneyWorksNameTypeDefinition[] =
	[
		...
		},
		{
			...
			manualSource: "moneyworks_appendix_names.html",
			businessContext:
				"Name has outstanding receivables and full debtor functionality (aging, credit limits, etc.)",
		},
	];
...
export const MONEYWORKS_SUPPLIER_TYPE_DEFINITIONS: MoneyWorksNameTypeDefinition[] =
	[
		...
		},
		{
			...
			manualSource: "moneyworks_appendix_names.html",
			businessContext:
				"Name has outstanding payables and full creditor functionality (aging, payment terms, etc.)",
		},
	];
...
export const MONEYWORKS_DUAL_CONTACT_BUSINESS_RULES = [
	{
		...
		canonicalRule:
			"Names provides built-in contact fields for up to 2 contacts, Contacts subfile provides unlimited expansion",
		manualSource:
			"moneyworks_appendix_names.html + moneyworks_appendix_contacts.html",
		businessContext:
			"Dual-layer architecture optimizes for common case (1-2 contacts) while supporting complex hierarchies",
	},

	{
		...
		canonicalRule:
			"Names.Contact (25 chars) vs Names.Contact2 (29 chars) - different field capacities within same entity",
		manualSource: "moneyworks_appendix_names.html",
...

	{
		...
		ruleType: "capacity" as const,
		canonicalRule:
			"Names.email (80 chars) vs Contacts.eMail (63 chars) - Names provides more email capacity",
		manualSource:
			"moneyworks_appendix_names.html + moneyworks_appendix_contacts.html",
		businessContext:
			"Built-in Names email fields optimized for longer email addresses",
	},

	{
		...
		ruleType: "capacity" as const,
		canonicalRule:
			"Names.Mobile (14 chars), Names.Mobile2 (13 chars) vs Contacts.Mobile (19 chars) - Contacts provides more mobile capacity",
		manualSource:
			"moneyworks_appendix_names.html + moneyworks_appendix_contacts.html",
		businessContext:
			"Contacts subfile optimized for longer international mobile numbers",
	},

	{
		...
		ruleType: "capacity" as const,
		canonicalRule:
			"Names.Position/Position2 (29 chars) vs Contacts.Position (39 chars) - Contacts provides more position capacity",
		manualSource:
			"moneyworks_appendix_names.html + moneyworks_appendix_contacts.html",
...

	{
		...
		ruleType: "capacity" as const,
		canonicalRule:
			"Names.Contact (25 chars), Names.Contact2 (29 chars) vs Contacts.Contact (39 chars) - Contacts provides most capacity",
		manualSource:
			"moneyworks_appendix_names.html + moneyworks_appendix_contacts.html",
		businessContext:
			"Contacts subfile supports longer contact names for international scenarios",
	},
];
...
export const MONEYWORKS_DUAL_CONTACT_USAGE_PATTERNS = [
	{
		...
		reasoning:
			"Most businesses need only 1-2 contacts per Name, built-in fields provide fastest access",
		businessTypes: [
			"small retail",
...

	{
		...
		recommendation:
			"Use Names for primary contacts + Contacts subfile for additional",
		reasoning:
			"Primary contacts in Names for fast access, additional contacts in Contacts for full details",
		businessTypes: [
			"medium enterprises",
		...
		canonicalApproach:
			"Names.Contact/Contact2 + Contacts subfile for 3+ contacts",
	},

	{
		...
		reasoning:
			"Complex role management, contact ordering, and unlimited expansion required",
		businessTypes: [
			"large corporations",
			"government entities",
			"complex suppliers",
		...
		canonicalApproach:
			"Contacts subfile with role-based management, Names fields optional",
	},

	{
		...
		reasoning:
			"Longer international names, mobile numbers, positions require Contacts field capacities",
		businessTypes: [
		...
		canonicalApproach:
			"Contacts subfile for extended field lengths and character support",
	},
];
 ...
 */
export function validateNameTypeCanonical(
	customerType: number,
	supplierType: number,
): {
	isValid: boolean;
	...
	if (!validCustomerTypes.includes(customerType)) {
		warnings.push(
			`Invalid CustomerType ${customerType}. MoneyWorks canonical values: 0 (not customer), 1 (customer), 2 (debtor)`,
		);
	}
	...
	if (!validSupplierTypes.includes(supplierType)) {
		warnings.push(
			`Invalid SupplierType ${supplierType}. MoneyWorks canonical values: 0 (not supplier), 1 (supplier), 2 (creditor)`,
		);
	}
 ...
 */
export function getCanonicalNameTypeExplanation(
	customerType: MoneyWorksCustomerType,
	supplierType: MoneyWorksSupplierType,
): string {
	const customerDef = MONEYWORKS_CUSTOMER_TYPE_DEFINITIONS.find(
		(def) => def.type === customerType,
	);
	const supplierDef = MONEYWORKS_SUPPLIER_TYPE_DEFINITIONS.find(
		(def) => def.type === supplierType,
	);

	const customerDesc = customerDef
		? `${customerDef.canonicalName} (${customerDef.businessContext})`
		: "Unknown customer type";
	const supplierDesc = supplierDef
		? `${supplierDef.canonicalName} (${supplierDef.businessContext})`
 ...
 */
export function isCanonicalDebtor(
	customerType: MoneyWorksCustomerType,
): boolean {
 ...
 */
export function isCanonicalCreditor(
	supplierType: MoneyWorksSupplierType,
): boolean {
 ...
 */
export function getCanonicalAccountRelationships(
	customerType: MoneyWorksCustomerType,
	supplierType: MoneyWorksSupplierType,
): {
	...
	if (needsReceivables)
		explanation +=
			"Requires RecAccount (Accounts Receivable control account for debtor). ";
	if (needsPayables)
		explanation +=
			"Requires PayAccount (Accounts Payable control account for creditor). ";
	if (!needsReceivables && !needsPayables)
		explanation += "No control account requirements.";
