...
export const MONEYWORKS_PRODUCT_FIELDS = [
	...
	},
	{
		...
		maxLength: 19,
		canonicalDescription:
			"The item's barcode. This can be used in transaction entry instead of the product code",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		fieldName: "Hash",
		dataType: "N" as const,
		canonicalDescription:
			"For fast searching of products by buy/sell/stock. A bit is set for each status: If buy, #0002; if sell, #0004, if inventory, #0008, Thus all inventoried items will have Hash >= 8.",
		manualSource: "moneyworks_appendix_products.html",
		isRequired: true,
		isIndexed: true,
	},
	...
	// PURCHASING FIELDS
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The undiscounted buy price of one buy unit of the item (in the currency of the purchase). This is updated automatically by MoneyWorks if 'Update price whenever purchased' option is on",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
	...
	},
	{
		...
		maxLength: 5,
		canonicalDescription:
			'The units in which you buy the product. e.g. "ea", "kg", "ml", "dz". If the buy units are different from the sell units, you must supply a scalar conversion factor in the ConversionFactor field that will convert from buy units to sell units.',
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		fieldName: "BuyWeight",
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"This is used to calculate the number of sell units that equate to one buy unit. When you purchase product, the quantity purchased is divided by this conversion factor to calculate the number of selling units of stock on hand. Note that the reciprocal of the conversion factor is displayed on the product entry screen.",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		fieldName: "CostPrice",
		dataType: "N" as const,
		canonicalDescription:
			"The standard cost of the item. For purchased items, this is the purchase price (adjusted for discount if any) converted to the base currency.",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		fieldName: "Supplier",
		...
		maxLength: 11,
		canonicalDescription:
			"The supplier code of your usual supplier. If present, this should be the code of a supplier in the names list.",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		...
		maxLength: 19,
		canonicalDescription:
			"The product code that your usual supplier uses to refer to the product.",
		manualSource: "moneyworks_appendix_products.html",
	},
	...
	// SELLING FIELDS
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			'The "A" sell price at which you sell the product. This is GST exclusive and exclusive of any discount that you may apply.',
		manualSource: "moneyworks_appendix_products.html",
	},
	{
	...
	},
	{
		...
		maxLength: 5,
		canonicalDescription:
			'The units in which you sell the product. e.g. "ea", "kg", "ml", "doz"',
		manualSource: "moneyworks_appendix_products.html",
	},
	{
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The percentage discount. This is used only if the discount mode is 1 or 3",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"A number representing the discount mode as selected in the discount mode pop-up menu in the product entry window. 1=None; 2 = by customer; 3 = by product; 4=Add",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The A sell price, if the quantity is greater than or equal to QtyBreak1",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The A sell price, if the quantity is greater than or equal to QtyBreak2",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The A sell price, if the quantity is greater than or equal to QtyBreak3",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The A sell price, if the quantity is greater than or equal to QtyBreak4",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The B sell price, if the quantity is greater than or equal to QtyBreak1",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The B sell price, if the quantity is greater than or equal to QtyBreak2",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The B sell price, if the quantity is greater than or equal to QtyBreak3",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The B sell price, if the quantity is greater than or equal to QtyBreak4",
		manualSource: "moneyworks_appendix_products.html",
	},
	...
	// INVENTORY MANAGEMENT
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The total number of items of stock of the product that you have on hand. This is represented in the selling units for the product. Use the SOHForLocation(location) function for the stock at a given location",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The stock level at which a reordering warning should be given. (in selling units)",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
	...
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The minimum build quantity--items must be built in multiples of this",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
	...
	// STOCK TAKE FIELDS
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The total entered stock count for a stock take. Use the StocktakeNewQtyForLocation(location) function for the entered stock count at a given location",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The total stock on hand when a stock take is commenced. Use the StockTakeStartQtyForLocation(location) function for the commencing stock at a given location",
		manualSource: "moneyworks_appendix_products.html",
	},
	...
	// ACCOUNT RELATIONSHIPS
	{
		...
		maxLength: 13,
		canonicalDescription:
			"Cost Of Goods account. If you only buy the product, this is the Expense account that is debited each time you purchase this product. If you stock and sell the product, this account is debited when you sell the product.",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		fieldName: "SalesAcct",
		...
		maxLength: 13,
		canonicalDescription:
			"The Income account that is credited whenever the product is sold.",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		fieldName: "StockAcct",
		...
		maxLength: 13,
		canonicalDescription:
			"The Current Asset account that is debited whenever you buy a product that you stock and is credited whenever you sell it.",
		manualSource: "moneyworks_appendix_products.html",
	},
	...
	// JOB COSTING FIELDS
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"Sell price determinator for job costing: 1 = Use Product Sell Price, 2 = Apply Job Markup to Standard Cost, 3 = Use Undiscounted Purchase Price",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The minimum margin/markup level for the product below which to show a warning on the Selling Price screen",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		fieldName: "Plussage",
		dataType: "N" as const,
		canonicalDescription:
			"Amount to add to the purchase price for margin calculations within the product sell matrix. Not included in the costs maintained by MoneyWorks",
		manualSource: "moneyworks_appendix_products.html",
	},
	...
	// METADATA AND EXTENSIBILITY
	{
		...
		dataType: "N" as const,
		canonicalDescription:
			"The colour of the product record (not necessarily of the actual product), represented internally as a numeric index in the range 0-7 but rendered as a textual colour name",
		manualSource: "moneyworks_appendix_products.html",
	},
	{
		fieldName: "Comment",
	...
	[
		{
			...
			manualSource: "moneyworks_appendix_products.html",
			businessContext:
				"Physical or digital goods that can be bought, sold, and inventoried",
		},
		{
			...
			manualSource: "moneyworks_appendix_products.html",
			businessContext:
				"Reusable assets or capabilities used in business operations",
		},
		{
		...
		},
		{
			...
			manualSource: "moneyworks_appendix_products.html",
			businessContext:
				"Miscellaneous items that don't fit standard product categories",
		},
	];
...
export function validateProductStatusCanonical(hash: number): {
	...
	if (isInventoried && hash < 8) {
		warnings.push(
			"MoneyWorks canonical rule: All inventoried items must have Hash >= 8",
		);
	}

	if (isInventoried && !canBuy && !canSell) {
		warnings.push(
			"MoneyWorks business logic: Inventoried products should be buyable and/or sellable",
		);
	}
...
export function validateProductTypeCanonical(type: string): {
	...
	if (!validTypes.includes(type)) {
		warnings.push(
			`Invalid ProductType ${type}. MoneyWorks canonical values: P (product), R (resource), T (time), S (ship method), O (other)`,
		);
	}
 ...
 */
export function getCanonicalProductTypeExplanation(
	type: MoneyWorksProductType,
): string {
	const typeDef = MONEYWORKS_PRODUCT_TYPE_DEFINITIONS.find(
		(def) => def.type === type,
	);
	return typeDef
		? `${typeDef.canonicalName}: ${typeDef.businessContext}`
...
export function getCanonicalProductAccountRelationships(hash: number): {
	...
	if (needsSales)
		explanation += "Requires SalesAcct (Income account for sales). ";
	if (needsStock)
		explanation += "Requires StockAcct (Current Asset account for inventory). ";
	if (!needsCOG && !needsSales && !needsStock)
		explanation += "No account requirements.";
...
export function validateSellDiscountModeCanonical(mode: number): {
	...
	return {
		...
		explanation:
			explanations[mode as keyof typeof explanations] ||
