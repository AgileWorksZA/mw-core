...
export const AssetOne = t.Object(
  {
    ...
    LastDepreciatedDate: t.Optional(
      t.Nullable(
        t.String({
          description:
    ...
    Dept: t.Optional(
      t.Nullable(
        t.String({
          description:
            "The asset department (must be a MoneyWorks Department code).",
          maxLength: 5,
        }),
      ),
    ),
    PrivateUsePercent: t.Optional(
      t.Nullable(
        t.Integer({
          description:
    ...
    Status: t.String({
      description:
        "The asset status. Values: NEW, ACT, NDP, OTH, DSP. NEW: Newly entered asset, not yet depreciated. ACT: Active asset, has been depreciated. NDP: Non-depreciable asset. OTH: Other asset type for record keeping. DSP: Disposed asset.",
    }),
    LastModifiedBy: t.Optional(
      t.Nullable(
        t.String({
          description:
    ...
    ExpectedResidualValue: t.Optional(
      t.Nullable(
        t.Integer({
          description:
    ...
    RevalSurplusImpairAmt: t.Optional(
      t.Nullable(
        t.Integer({
          description:
