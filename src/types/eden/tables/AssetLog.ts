...
export const AssetLogOne = t.Object(
  {
    ...
    ParentSeq: t.Optional(t.Nullable(t.Integer({
    ...
    Adjustment2: t.Optional(t.Nullable(t.Integer({
    ...
    Rate: t.Optional(t.Nullable(t.Integer({
      description: "Depreciation rate used for this action (if applicable)."
    }))),
    PrivateUsePercent: t.Optional(t.Nullable(t.Integer({
