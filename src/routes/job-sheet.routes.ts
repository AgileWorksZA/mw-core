  ...
  .get('/job-sheets/:sequenceNumber',
    async ({ params }) => {
      try {
        ...
        return await jobSheetService.getJobSheetBySequenceNumber(sequenceNumber);
      } catch (error) {
        console.error(`Error in GET /job-sheets/${params.sequenceNumber}:`, error);
        throw error;
      }
    },
    {
  ...
  .get('/job-sheets/for-job/:jobCode',
    async ({ params }) => {
      try {
        ...
        console.error(`Error in GET /job-sheets/for-job/${params.jobCode}:`, error);
        throw error;
      }
    },
    {
